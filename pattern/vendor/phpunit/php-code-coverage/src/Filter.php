...
class Filter
{
     ...
     * @param string $prefix
     */
    public function addDirectoryToWhitelist($directory, $suffix = 'index.php', $prefix = '')
    {
     ...
     * @param string $prefix
     */
    public function removeDirectoryFromWhitelist($directory, $suffix = 'index.php', $prefix = '')
    {
        $facade = new \File_Iterator_Facade;
        $files  = $facade->getFilesAsArray($directory, $suffix, $prefix);
